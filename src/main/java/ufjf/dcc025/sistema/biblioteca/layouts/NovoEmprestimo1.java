 ...
 * @author arauj
 */
public class NovoEmprestimo1 extends javax.swing.JFrame {

    /**
     * Creates new form NovoEmprestimo
     */
    public NovoEmprestimo1() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NovoEmprestimo1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NovoEmprestimo1().setVisible(true);
            }
        });
    }
