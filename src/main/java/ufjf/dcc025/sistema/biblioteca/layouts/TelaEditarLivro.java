...
public class TelaEditarLivro extends javax.swing.JFrame {
     ...
     */
    public TelaEditarLivro(ArrayList<Livro> lista, int id ) {
        initComponents();
        lista.
        setLocationRelativeTo( null );
        jTextFieldNome.setText( lista.get(id).getNome());
        jTextFieldAutor.setText( lista.get(id).getAutor());
        jTextFieldEditora.setText( lista.get(id).getEditora());
        jTextFieldAcervo.setText( ""+lista.get(id).getQuantAcervo());
        jTextFieldEmprestimo.setText(""+lista.get(id).getQuantEmprestimo());
        jTextFieldAno.setText( lista.get(id).getAno());
        jTextFieldEdicao.setText( lista.get(id).getEdicao());
    }
